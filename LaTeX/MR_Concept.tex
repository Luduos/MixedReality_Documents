...
\begin{abstract}
  This paper describes the concept for the final project of the seminar ``Making Mixed Reality great again!''. In the beginning, the project and required terminology are introduced, as well as requirements for running the proposed Augmented Reality, locally cooperative game. 
