...
\begin{abstract}
  This paper describes the concept for the final project of the seminar ``Making Mixed Reality great again!''. In the beginning, the project and required terminology are introduced, as well as requirements for starting the proposed application. The following sections lead through the two game modes: 
\end{abstract}
